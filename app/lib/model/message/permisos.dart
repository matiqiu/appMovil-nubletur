...
class permisos extends StatefulWidget {
  permisos({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _permisos createState() => _permisos();
}

class _permisos extends State<permisos> {
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            /*_buildButtonRequestPermissionInternet(Permission., context),*/
  ...
  Widget _buildButtonRequestPermissionInternet(
      Permission permission, BuildContext context) {
    return _buildButton(
        Colors.yellow[300], 'Solicitud permiso Internet', permission, context);
  }
