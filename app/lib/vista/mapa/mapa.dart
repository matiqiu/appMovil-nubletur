...
//import 'package:tesis/model/message/permisos.dart';
...
class paginamapa extends StatefulWidget {
  @override
  _paginamapa createState() => new _paginamapa();
}

class _paginamapa extends State<paginamapa> {
  GoogleMapController _controller;

  final _initialPositon = LatLng(-36.60664, -72.10344);
  ...
  final geoMethods = GeoMethods(
    googleApiKey: 'AIzaSyCeZlPcq4WMn39889TnQ3oT81N6ByBmGD8',
    language: 'es-419',
    countryCode: 'cl',
    country: 'Chile',
    city: 'Chillan',
